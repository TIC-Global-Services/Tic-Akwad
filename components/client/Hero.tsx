...
const Hero = () => {
  return (
    <div className='flex h-[100dvh] bg-black items-center justify-center text-center'>
         <div >
            <h1 className='text-[80px] leading-[92px] max-w-5xl text-white font-medium tracking-tighter mx-auto'>
                Welcome, We Onboard  <br />
                <span className='text-[#1773FF]'>2</span> Projects a Month
            </h1>
            <p className='text-center md:text-xl mt-5 max-w-2xl mx-auto'>
